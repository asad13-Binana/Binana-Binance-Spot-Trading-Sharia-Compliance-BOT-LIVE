...
This is the live-capable package for revision `2026-08-01J`; its internal
release identifier is `V10.2-CODEX-2026-08-01J`. The canonical revision 01I
artifacts remain unchanged. The package ships in simulation mode and requires
signed promotion evidence before its live execution path can arm.
...
- Automated Sharia screening now requires controller-bound, report-bound,
  ...
  mandatory for this live-capable package. This is automated research logic,
  not a fatwa.
...
- Fresh working-tree, CI-style tar, Git round-trip, and launcher simulations
  passed.  The package gate ran 346 core tests (341 passed and 5 skipped),
