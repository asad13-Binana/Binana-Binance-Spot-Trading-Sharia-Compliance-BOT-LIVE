...
execution-state/P&L/signal data separation, correct v101 paths and live port,
...
docs/EXTERNAL_VALIDATION_RUNBOOK.md for the remaining blockers. This live-capable
package remains fail-closed in simulation until promotion evidence is supplied.
